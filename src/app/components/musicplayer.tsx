...
export default function MusicPlayer(song: Song) {
  return (
    <div className=" text-white max-w-[400px] w-full grid grid-rows-[4fr_1fr] grid-cols-1 sm:hover:scale-[100%] transition-all ease-in-out duration-40 aspect-[4/5] relative snap-center">
