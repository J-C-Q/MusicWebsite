    ...
    <>
      <main className="rounded-b-xl">
        ...
        <div className=" text-md sm:text-4xl px-5 sm:px-20 bg-gradient-to-b from-[#ffffff] to-[#302c2a] inline-block text-transparent bg-clip-text font-bold">
          ...
          mu&shy;sic com&shy;bines ev&shy;ery stage of falling in love that
          in&shy;cludes dis&shy;tance. Cre&shy;at&shy;ing an orig&shy;i&shy;nal
          sound in&shy;spired by Olivia Ro&shy;dri&shy;go & The1975. I
          pro&shy;duced my first 4 sin&shy;gles in Los An&shy;ge&shy;les which
